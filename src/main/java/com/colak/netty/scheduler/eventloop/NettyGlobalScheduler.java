...
@Slf4j
public class NettyGlobalScheduler implements NettyScheduler {
    ...
    public ScheduledFuture<?> scheduleFixedRateTimer(FixedRateTimerParameters parameters) {
        ...
        ScheduledFuture<?> scheduledFuture = workerGroup.scheduleAtFixedRate(parameters.getTask(), parameters.getInitialDelay(),
